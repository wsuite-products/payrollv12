...
- **Improvement:** exclude `ir.ui.menu` attachments from eligible to be stored outside (e.g. `ir_attachment_s3_werp`). There is only one small web icon image in this model - no point to store it outside
